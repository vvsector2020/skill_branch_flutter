...
void main() {
  ...
  test('registerUserByPhone', () {
    ...
    expect("email@domain.zone", user1.login);
    expect("email@domain.zone", user1.email);
  ...
  test('checkUserFriendShips', () {
    User user1 = holder.registerUserByEmail("SkiLl DRanch", "popkadur@tm.ur");
    User user2 =
        holder.registerUserByEmail("SkiLl DRanch2", "email2@domain.zone");
    User user3 = holder.registerUserByEmail("SkiLl DR2", "email3@domain.zone");
